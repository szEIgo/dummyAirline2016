   ...
   static int smallRand;
    ...
    public static void generator(int amount) {
        ...
        for (int i = 1; i < amount; i++) {
            ...
            String[] ft = fromTo();
            System.out.println("('" + tempFF + tempID + "', '" + "FHA" + tempFF + "', '" + makeDate() + "T"+twentifour()+":00:00.000Z" + "', " + availableSeats[random.nextInt(4)] + ", " + makePrice(Integer.parseInt(makeDay()), random.nextInt(100) + 1) + ", '" + random.nextInt((250) + 60) + "', '" + ft[0] + "', '" + ft[1] + "'),");
    ...
    public static String twentifour(){
        smallRand = random.nextInt(24);
      if (smallRand < 10) {
            return "0" + smallRand;
        }  
    return  ""+  smallRand;
